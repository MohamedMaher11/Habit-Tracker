...
int _habitEstimateSize(
  ...
  bytesCount += 3 + object.completename.length * 8;
...
void _habitSerialize(
  ...
  writer.writeDateTimeList(offsets[0], object.completename);
...
Habit _habitDeserialize(
  ...
  final object = Habit();
  object.completename = reader.readDateTimeList(offsets[0]) ?? [];
  object.id = id;
...
extension HabitQueryFilter on QueryBuilder<Habit, Habit, QFilterCondition> {
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completenameElementEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition>
      completenameElementGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completenameElementLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completenameElementBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completenameLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completenameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'completename',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completenameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'completename',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completenameLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> completenameLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HabitQueryWhereDistinct on QueryBuilder<Habit, Habit, QDistinct> {
  QueryBuilder<Habit, Habit, QDistinct> distinctByCompletename() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'completename');
    });
  }
...
extension HabitQueryProperty on QueryBuilder<Habit, Habit, QQueryProperty> {
  ...
  QueryBuilder<Habit, List<DateTime>, QQueryOperations> completenameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'completename');
    });
  }
